...
# (id, название, базовые часы) — сумма = 200 (см. README, дорожная карта).
PHASES = [
    (0, "Setup & Tooling", 8), (1, "Как работают LLM", 12), (2, "Промпт-инжиниринг", 16),
    (3, "Текст и документы", 14), (4, "Скиллы, память, проекты", 16), (5, "Данные и аналитика", 18),
    (6, "Инструменты и MCP", 18), (7, "Agent Engineering", 18), (8, "Мульти-агенты", 14),
    (9, "FinOps", 14), (10, "Production", 12), (11, "Этика и governance", 10), (12, "Capstone", 30),
]
