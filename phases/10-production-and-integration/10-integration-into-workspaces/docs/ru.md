...
> **Врезка (2026): self-hosted агент-рантайм и многоканальность.** Агента можно деплоить не только за API, но и на локальную платформу — **OpenClaw / Hermes** (MIT): скиллы, память, мульти-модельная оркестрация и подключение к 50+ каналам (Telegram, Slack, WhatsApp, Signal). Удобно для персонального агента с многоканальным доступом (подробно — урок 4.5). Те же гарантии — фича-флаг, fallback, контроль доступа — остаются.
