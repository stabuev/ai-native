...
| 0.4 | Как проходить практику курса | — | Личная папка, три пути выполнения и рамка AI Fluency 4D | Проверенный рабочий цикл + безопасный коммит Фазы 0 | `phases/00-setup-and-tooling/04-course-conventions` |

**Домашнее задание.** Поднять окружение, пройти `/find-your-level`, связать результаты Фазы 0 в `course-work/README.md`, исключить секреты и безопасно закоммитить личную папку перед следующим шагом маршрута.
