...
**Домашнее задание.** Собрать token-budgeter и заполнить реестр проверки одного ответа модели: сопоставить утверждения с доверенным источником и обосновать решение с учётом цены ошибки.
