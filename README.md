...
**Домашнее задание.** Выбрать одну повторяемую задачу своей роли, подготовить baseline
и candidate с одним изменением, собрать не менее 10 обоснованных случаев с обычными,
граничными и защищёнными срезами, отделить контрольные случаи и прогнать eval-harness.
Сдать eval-пакет с общим и посрезовым результатом, парными регрессиями, решением
`accept / review / reject` и границами вывода.
